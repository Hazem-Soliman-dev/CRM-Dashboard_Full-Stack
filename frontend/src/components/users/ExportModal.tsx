...
export const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, users }) => {
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <label className="flex items-center space-x-3">
                  ...
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Include Performance Data</span>
                </label>
                <label className="flex items-center space-x-3">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">Include Activity Logs</span>
                </label>
              </div>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-700 dark:text-blue-400">
                ...
                <div>Records: {users.length} users</div>
              </div>
            </div>
          </div>
