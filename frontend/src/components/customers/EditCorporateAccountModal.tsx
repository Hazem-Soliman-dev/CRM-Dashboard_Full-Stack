...
interface EditCorporateAccountModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const EditCorporateAccountModal: React.FC<EditCorporateAccountModalProps> = ({ isOpen, onClose, onSave, account }) => {
  ...
  useEffect(() => {
    if (account && isOpen) {
      setFormData({
        ...
        primaryContactName: account.primaryContact || '',
        primaryContactEmail: account.email || '',
        primaryContactPhone: account.phone || '',
        accountManager: account.accountManager || 'Sarah Johnson',
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">
                Edit Corporate Account - {account.companyName}
              </h2>
            </div>
            <button
              onClick={onClose}
