...
export const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose, attendance }) => {
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center space-x-3">
                ...
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">Include Detailed Time Logs</span>
              </label>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
              ...
              <div className="text-sm text-blue-700 dark:text-blue-400">
                ...
                <div>Records: {attendance.length} employees</div>
